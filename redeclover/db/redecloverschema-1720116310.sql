...
ALTER TABLE `produto_pedidos` ADD CONSTRAINT `produto_pedidos_fk1` FOREIGN KEY (`proped_usu_id`) REFERENCES `usuarios`(`usu_id`);

ALTER TABLE `produto_pedidos` ADD CONSTRAINT `produto_pedidos_fk2` FOREIGN KEY (`proped_ped_id`) REFERENCES `pedidos`(`ped_id`);
